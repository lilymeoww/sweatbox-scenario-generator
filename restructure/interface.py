...
class App(customtkinter.CTk):
    def __init__(self) -> None:
        ...
        selected = airportConfig.get("EGPH") # TODO: Un-hard code the ICAO. (Not a clue how though)
        self.currentAirport: Airport = Airport(selected.get("ICAO"), selected.get("elevation"), selected.get("runway"), selected.get("position"))
        self.approachData = "test"
